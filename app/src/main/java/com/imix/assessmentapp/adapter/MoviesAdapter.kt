...
import com.imix.assessmentapp.databinding.IvMainBinding
...
class MoviesAdapter: BaseRecyclerViewAdapter<Data, IvMainBinding>() {
    override fun getLayout() = R.layout.iv_main

    override fun onBindViewHolder(
        holder: Companion.BaseViewHolder<IvMainBinding>,
        position: Int
    ) {
        holder.binding.apply {
            tvShows = items[position]
